package com.soapws.example.demo;
...
import com.soapws.example.demo.exception.DetailSoapFaultDefinitionExceptionResolver;

@EnableWs
@Configuration
//which configures annotation driven Spring-WS programming model
public class SoapConfig extends WsConfigurerAdapter {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema countriesSchema) {
		...
		wsdl11Definition.setTargetNamespace("https://www.synctech.ga/xml/student");
